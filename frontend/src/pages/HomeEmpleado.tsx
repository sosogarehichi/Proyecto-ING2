...
export default function HomeEmpleado() {
  ...
  const opciones = [
    { label: 'Ver Reservas', ruta: '/ReservasActivasEmpleado' },
    { label: 'Iniciar Reserva', ruta: '/ReservaEmpleado' }
  ];
  ...
  return (
    <Box minHeight="100vh" bgcolor="#f4f4f4">
      ...
      <Box px={4} py={5}>
        ...
        <Grid container spacing={3} justifyContent="center" maxWidth={800} mx="auto">
